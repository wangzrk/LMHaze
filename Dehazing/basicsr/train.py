...
# sys.path.append("/home/a/Desktop/MoE-Mamba")
...
def main():
    ...
    while current_iter <= total_iters:
        ...
        while train_data is not None:
            ...
            model.feed_train_data_moe({'lq': lq, 'gt':gt, 'logit': logit})
            model.optimize_parameters_moe(current_iter)
